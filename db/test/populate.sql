...
insert into users (id,username,password,avatar,token) values (1,'bob','$2a$08$mrZQOHperHfwQrc1au5CIecSwA6sy1VceDQIEu7SrzKA/qcXcMsoG', 'http://images.apple.com/global/elements/flags/16x16/usa_2x.png', 'tok');
